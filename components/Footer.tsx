...
import Link from 'next/link'; // Penting untuk tautan internal di Next.js

// Pindahkan array konstanta ke sini, di luar return statement
const SOCIAL_ICONS = [
  {
    label: "Facebook",
...
const Footer: React.FC = () => {
  ...
  return (
    <div className="w-full bg-transparent text-white pt-12 pb-8 sm:pt-16 sm:pb-12 lg:pt-20 lg:pb-16">
      <div className="px-6 md:px-12 lg:px-16 max-w-7xl mx-auto flex flex-col items-center">
        
        {/* Garis Pembatas */}
        <div className="w-full border-t border-white/10 mb-8 sm:mb-12"></div>

        {/* Ikon Sosial yang dikoreksi */}
        <div className="flex space-x-6 mb-8 text-white/70">
          {SOCIAL_ICONS.map((item) => (
            // LANGSUNG GUNAKAN TAG <a> UNTUK LINK EKSTERNAL
            // Tidak perlu Link, passHref, atau legacyBehavior lagi
            <a 
              key={item.label} 
              href={item.href} 
        ...
        {/* Paragraf untuk teks copyright */}
        <p className="text-gray-400 text-sm text-center">
          &copy; {currentYear} Muhammad Zidni Ma'ruf | Software Engineering Student.
        </p>
